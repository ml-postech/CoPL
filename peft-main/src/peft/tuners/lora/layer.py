        ...
        **kwargs,
        ...
        if self.multiple_loras:
            ...
            if self.cluster:
                ...
                # self.w_gate = nn.Linear(512, self.num_experts)
                self.w_gate = nn.Sequential(nn.Linear(512, 256), 
                                            nn.ReLU(), 
        ...
        if self.disable_adapters:
            ...
            if self.multiple_loras:
                ...
                if self.cluster:
                    ...
                    emb = torch.tensor(self.input_emb, device=device)
...
class SparseDispatcher(object):
    ...
    def combine(self, expert_out, multiply_by_gates=True):
        ...
        try:
            combined = zeros.index_add(0, self._batch_index, stitched.to(zeros.dtype))
        except RuntimeError:
            import ipdb
            ipdb.set_trace()
